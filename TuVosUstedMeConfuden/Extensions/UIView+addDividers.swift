...
extension UIView {
    ...
    func addDividers(heightMultiplier: CGFloat) {
        ...
        topBorderView.heightAnchor.constraint(equalTo: heightAnchor, multiplier: heightMultiplier).isActive = true
        ...
        bottomBorderView.heightAnchor.constraint(equalTo: heightAnchor, multiplier: heightMultiplier).isActive = true

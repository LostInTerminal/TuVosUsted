...
struct Countries {
    ...
    let inSpanish_EnglishOrder = ["Argentina", "Bolivia", "Chile", "Colombia", "Costa Rica", "Cuba", "República Dominicana", "Ecuador", "El Salvador", "Guinea Equatorial", "Guatemala", "Honduras", "México", "Nicaragua", "Panamá", "Paraguay", "Perú", "Puerto Rico", "España", "Uruguay", "Venezuela", ""]

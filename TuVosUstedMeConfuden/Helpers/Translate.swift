...
class Translate {
    ...
    static func question(language: String, question: String) -> String {
    ...
    static func country(language: String, word: String) -> String {
    ...
    static func person(language: String, word: String) -> String {
    ...
    static func tertiary(language: String, country: String, word: String) -> String {
